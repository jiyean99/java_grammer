...
public class C09Array {
    public static void main(String[] args) {
        ...
        // 배열표현식(3)의 활용 예시 : 배열 객체를 다른 메서드의 매개변수로 사용할 경우
        ...
        // sort 메서드는 정렬에 대한 최적의 알고리즘이 구현되어있다 -> 직접 알고리즘으로 구현하기보다는 메서드를 쓰라는 뜻
        // 내장 메서드의 복잡도 = nlog(n)
        ...
        // sort 메서드 사용시 데이터 만개면 10000*log(10000) = 10000*16 = 16만번 정도로 반복함.
        ...
        //📍 cf) 스테틱메서드, 객체메서드 메서드 종류에 따라 String.,Arrays. 이런식으로 쓸 수도 있고 변수명. 이런식으로 쓸 수 있는 메서드도 있다.
        //   클래스 메서드 vs 객체 메서드 추후에 다뤄볼것
